...
class TestReviewIDExtractorMethods(unittest.TestCase):
    ...
    def test_extract_height(self):
        ...
        self.assertEqual(self.hw.extract(text), {'weight': {'raw': [{'pound': 130}], 'pound': [130], 'kilogram': [58]}, 'height': {'foot': ['5\'5"'], 'raw': [{'foot': 5, 'inch': 5}], 'centimeter': [165]}})

        text = "\n \n Height: \r\n                          5'3''\r\n                       \n \n \n \n \n \n Weight: \r\n                          125 lbs\r\n                       \n \n \n \n \n \n"
        self.assertEqual(self.hw.extract(text), {'weight': {'raw': [{'pound': 125}], 'pound': [125], 'kilogram': [56]}, 'height': {'foot': ['5\'3"'], 'raw': [{'foot': 5, 'inch': 3}], 'centimeter': [160]}})

        
        text = "Breasts DD Eyes gray Height 1.52 Skin Tanned Weight 60"
        self.assertEqual(self.hw.extract(text), {'weight': {'raw': [{'kilogram': 60}], 'pound': [132], 'kilogram': [60]}, 'height': {'foot': ['4\'11"'], 'raw': [{'centimeter': 52, 'meter': 1}], 'centimeter': [152]}})
